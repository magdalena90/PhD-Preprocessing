...
```{r}
save(datExpr, datMeta, datGenes, file='./../Data/filtered_raw_data_old.RData')
#load('./../Data/filtered_raw_data_old.RData')
```
...
save(datExpr, datMeta, datGenes, DE_info, dds, file='./../Data/preprocessed_data_old.RData')
