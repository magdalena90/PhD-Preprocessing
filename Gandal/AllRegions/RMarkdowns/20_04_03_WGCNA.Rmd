...
best_power = datExpr %>% t %>% pickSoftThreshold(powerVector = c(1,2,seq(3,3.5,0.1)), RsquaredCut=0.8)
...
write.csv(modules, file='./../Data/clusters_imputed.csv', row.names=FALSE)
```
<br><br>
