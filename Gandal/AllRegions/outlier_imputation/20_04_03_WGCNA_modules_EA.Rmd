...
Load preprocessed dataset (preprocessing code in 20_04_02_data_preprocessing.Rmd) and clustering (pipeline in 20_04_03_WGCNA.Rmd)
...
if(file.exists(paste0('./../Data/dataset_', clustering_selected, '_imputed.csv'))){
  ...
  write.csv(dataset, file = paste0('./../Data/dataset_', clustering_selected, '_imputed.csv'), row.names = FALSE)
...
- SFARI scores 1 to 2 have a lower Module-Trait Median than genes with Neuronal annotations<span style="color:red">(!)</span>
...
Not only are SFARI genes not consistent with the other measurements, but they seem to contradict them. There is a big difference between all the metrics created from gene expression analysis and these scores.
