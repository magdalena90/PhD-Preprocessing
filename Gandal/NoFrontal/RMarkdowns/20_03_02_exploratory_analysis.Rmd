---
title: 'Exploratory Analysis for All Lobes but Frontal'
output:
  html_document:
    code_folding: 'hide'
---
...
- 3540 genes (~22%) are significant using a threshold of 0.05 for the adjusted p-value and a without a log Fold Change threshold (keeping the null hypothesis $H_0: lfc=0$)
...
- Log Fold Changes between 0.12 and 0.2 seem to separate the samples by Diagnosis best
