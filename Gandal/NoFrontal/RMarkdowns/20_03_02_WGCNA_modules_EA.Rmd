---
title: 'WGCNA Modules Exploratory Analysis for All Lobes but Frontal'
output:
  html_document:
    code_folding: 'hide'
---
...
- The results found here are more similar to the results when considering all brain regions than to the Frontal Lobe results:

- All SFARI scores have a lower median than all genes that have a neuronal-related annotation <span style="color:red">(!)</span>

- SFARI score 1 is the group with the lowest Gene Significance, with a lower median even than the genes without any type of SFARI or Neuronal annotation <span style="color:red">(!)</span>

- SFARI score 2 also has a median lower than the genes without any type of SFARI or Neuronal annotation <span style="color:red">(!)</span>

- The main difference between these results and the ones using all the brain regions is the behaviour of SFARI score 6. Here it has a lower distribution of Gene Significance
...
- This plot has a wider dispersion than the one considering all brain regions, but the conclusions are the same as before

  - The higher the SFARI score, the **lower** the Module-Trait correlation

  - SFARI score 1 has significantly **lower** values of Module-Trait correlation than the rest of the groups

- On this dataset many genes seem to belong to modules with a Module-Diagnosis correlation very close to 1

- SFARI scores 1 and 6 has genes belonging to modules with very low Module-Diagnosis correlation
