...
- Leaves less genes without cluster than the algorithm using all the brain regions (1031 vs 4288)

- Creates many more clusters than the when using all the brain regions together (374 vs 192)
...
- More genes are left without a cluster than when considering the samples from all the brain regions (275 vs 54)

- Many more modules than when considering all the brain regions (270 vs 59)
