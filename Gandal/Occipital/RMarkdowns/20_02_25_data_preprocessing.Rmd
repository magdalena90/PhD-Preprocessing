---
title: 'Data preprocessing for Occipital Lobe'
output:
  html_document:
    code_folding: 'hide'
---
...
thresholds = round(100*(23-seq(23,0,-1))/23)
...
Comparing the mean expression of each sample by batch, this time, the differebce between batches doesn't seem that big
```{r, warning=FALSE}
