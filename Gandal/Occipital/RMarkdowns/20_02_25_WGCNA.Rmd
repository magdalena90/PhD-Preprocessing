---
title: 'Perform WGCNA for Occiptal Lobe'
output:
  html_document:
    code_folding: 'hide'
---
...
best_power = datExpr %>% t %>% pickSoftThreshold(powerVector = c(1,3, seq(5,6,0.2)), RsquaredCut=0.8)
...
- Leaves less genes without cluster than the algorithm using all the brain regions (1094 vs 4288)

- Creates many more clusters than the when using all the brain regions together (387 vs 192)
...
- More genes are left without a cluster than when considering the samples from all the brain regions (217 vs 54)

- Many more modules than when considering all the brain regions (262 vs 59)
