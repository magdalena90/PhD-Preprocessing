---
title: 'SFARI Genes for Occipital Lobe'
output:
  html_document:
    code_folding: 'hide'
---
...
### Effects of modifying filtering threshold by SFARI score
 ...
 - The behaviour is similar to the one found when considering all of the brain regions but noisier
 
 - All SFARI scores except 5 are more affected by the filtering than the genes with Neuronal-related functional annotations

- Using the null hypothesis $H0: lfc=0$, 103/910 SFARI genes are statistically significant (~11%)
