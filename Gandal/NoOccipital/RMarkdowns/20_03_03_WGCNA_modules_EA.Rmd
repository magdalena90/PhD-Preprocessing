---
title: 'WGCNA Modules Exploratory Analysis for All Lobes but Occipital'
output:
  html_document:
    code_folding: 'hide'
---
...
- All SFARI scores have an equal or lower median than all genes that have a neuronal-related annotation <span style="color:red">(!)</span>
...
- There isn't a clear pattern within the SFARI genes as the one we could see when studying all the brain regions together
...
SFARI genes are not very consistent with the other measurements, but they don't seem to contradict them in such as strong way as we had seen when studying all the brain regions together. Here it looks like they may be relatively independent from each other.
