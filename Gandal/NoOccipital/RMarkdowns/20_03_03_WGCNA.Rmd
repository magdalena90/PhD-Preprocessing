---
title: 'Perform WGCNA for All Lobes but Occipital'
output:
  html_document:
    code_folding: 'hide'
---
...
best_power = datExpr %>% t %>% pickSoftThreshold(powerVector = c(1, seq(2,3,0.2)), RsquaredCut=0.8)
...
- Creates less clusters than the when using all the brain regions together (109 vs 194)
...
- Less genes are left without a cluster than when considering the samples from all the brain regions (3 vs 54)

- More modules than when considering all the brain regions (36 vs 59)
